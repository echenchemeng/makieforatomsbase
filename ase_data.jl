...
# Po, At, Rn, Fr, Ra, Ac, everything after Np
    ...
    elseif data == "atomic_masses_iupac2016"
        return Vector([
    ...
    elseif data == "atomic_masses_legacy"
        return Vector([
    1.00794,  # H
    4.00260,  # He
    6.94100,  # Li
    ...
    elseif data == "atomic_masses_common"
        return Vector([
    1.00782503223,   # H
    4.00260325413,   # He
    7.0160034366,    # Li
...
# http://www.webelements.com
    elseif data == "ground_state_magnetic_moments"
        return Vector([
    1.0,  # H
    0.0,  # He
    1.0,  # Li
